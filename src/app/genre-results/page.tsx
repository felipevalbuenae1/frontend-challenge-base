        ...
        <div>
          ...
          {loading ? (
            ...
            <div className='d-flex justify-content-center m-5'>
              <Button onClick={handleLoadMore} className={`${styles.loadMoreButton} text-center warning`} variant='warning'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-clockwise" viewBox="0 0 16 16">
